 ...
 * @doc 类说明：单选列表容器
 */
class OperationAdapter internal constructor(private val mContext: Context, private val operations: List<Operation>?) : RecyclerView.Adapter<OperationAdapter.RecyclerViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: RecyclerViewHolder, position: Int) {
        ...
        viewHolder.operationTv.setOnClickListener { v ->
            if (onTListener != null) {
                onTListener!!.getItem(operations[position])
            }
        }
    }
